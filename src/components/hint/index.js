...
class Hint extends Component {
  ...
  renderHint() {
    ...
    if (this.showHint) {
      return <Container activeOpacity={opacity} onPress={onPress} animated style={[{
  ...
  renderHintContainer() {
    ...
    return <View {...others} testID={`${testID}.container`} style={[styles.container, style, this.getContainerPosition()]}>
        {this.renderHint()}
      </View>;
  }
